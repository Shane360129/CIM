...
| 🎮 **聊天室小遊戲** | 八款：圈圈叉叉、四子棋、五子棋、黑白棋、記憶翻翻樂（兩人對戰，兩個座位輪流）、2048、踩地雷（一起玩，輪流接手操作）、猜數字 1A2B（大家搶著猜）。盤面存在伺服器、在獨立的遊戲視窗裡玩，不會洗版聊天室 |
...
| 🎮 **小遊戲** | 八款遊戲選一款就開一局。**盤面不會畫在對話裡**：聊天室只留一張小卡（寫著是哪款遊戲、現在什麼狀況），按「開啟」才進到獨立的遊戲視窗玩。選單上方也會列出「這個聊天室進行中的遊戲」，隨時可以回到任何一局。玩到一半想換款式，遊戲視窗下方按「換個遊戲」就好。 |
